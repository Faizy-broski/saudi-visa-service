...
export default function Navbar() {
  ...
  return (
    <header
      ...
      style={{
        background: solid
          ? "linear-gradient(to right, #3CA5D4, #0E3254)"
          : "transparent",
        top: solid ? "0px" : "32px",
      }}
    >
      <nav className="max-w-6xl mx-auto px-4 md:px-6 py-3 flex items-center justify-between">
        ...
        <Link href="/">
          <img
            ...
            src="/images/logo.png"
            className="h-12 md:h-[70px] w-auto flex-shrink-0"
          />
        </Link>

        {/* Desktop nav pill */}
        <div
          className="hidden md:flex items-center bg-white/10 border border-white/15 rounded-full p-2 gap-0.5"
        >
        ...
        >
          <span
            className="block w-6 h-0.5 rounded-full bg-white transition-all"
            style={{
